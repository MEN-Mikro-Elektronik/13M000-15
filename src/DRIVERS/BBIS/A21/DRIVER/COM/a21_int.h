...
#elif __QNX__
# define A21_MMOD_BRIDGE_BUS_NO		3	/* QNX */
#else
...
#ifdef __QNX__
#define A21_MMOD_BRIDGE_DOMAIN_NO	0x0 /* No PCI domain for QNX */
#else
#define A21_MMOD_BRIDGE_DOMAIN_NO	0x2 /* PCI device number on domain 2 on vxWorks and Linux */
#endif
