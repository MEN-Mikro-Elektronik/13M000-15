...
#  
#         Author: ub
#          $Date: 2004/03/24 11:35:34 $
#      $Revision: 1.1 $
#  
#    Description: Make a QNX MDIS user state library (shared library)
#                      
#       Switches: 
...
TMP_OBJ_DIR	  := OBJ/$(COMP_NAME)_shared
...
CFLAGS          :=  $(TARGET_FLAGS) -c -O2 -shared $(DEF) \
...
$(COMP_OBJ): $(TMP_COMP_OBJS)
	$(CC) $(TARGET_FLAGS) -ggdb -shared -Wl,-soname,$(LIB_NAME)\
		-o $(COMP_OBJ) $(notdir $(TMP_COMP_OBJS)) -lc -lm 
