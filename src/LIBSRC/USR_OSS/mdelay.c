 ...
 *
 * $Log: mdelay.c,v $
 * Revision 1.1  2004/03/24 09:45:30  ub
 * Initial Revision
 *
 *
 *---------------------------------------------------------------------------
 ...
 ****************************************************************************/
static const char RCSid[]="$Header: /dd2/CVSR/QNX/src/LIBSRC/USR_OSS/mdelay.c,v 1.1 2004/03/24 09:45:30 ub Exp $";
 ...
 *
 * \qnx Since we don't have a timer that we can use, we try to measure
