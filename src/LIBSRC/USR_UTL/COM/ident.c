 ...
 *
 * $Log: ident.c,v $
 * Revision 1.15  2014/10/30 12:08:18  ch
 * (AUTOCI) Checkin due to new revision 1.31 of fileset COM/LIBSRC/usr_utl
 *
...
static const char RCSid[]="$Header: /dd2/CVSR/COM/LIBSRC/USR_UTL/COM/ident.c,v 1.15 2014/10/30 12:08:18 ch Exp $";
...
char* UTL_Ident( void )
{
	return("UTL - User Utilities: %FSREV COM/LIBSRC/usr_utl 1.31 2014-10-30%");
}
